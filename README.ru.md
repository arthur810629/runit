...
* node >= 18 (рекомендуется Node 22 LTS; Node 25 пока не поддерживается)
* [Yarn 1 (Classic)](https://classic.yarnpkg.com/)
* PostgreSQL для продакшена, либо SQLite для локальной разработки

Если у вас Node 25+, переключитесь на Node 22 LTS перед установкой зависимостей:
...
Если в локальном клоне есть `.nvmrc`, можно использовать:
